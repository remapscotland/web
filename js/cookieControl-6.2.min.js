// cookieControl version 6.2 (2013-12-12, R249, greg)
...
var CookieControl = {
    ...
    shouldOpen: function() {
        ...
        return this.options.startOpen && !this.hidden()
    },
...
function cookieControl(a) {
    if (typeof(a) === "undefined" || typeof(a.apiKey) === "undefined") {
        alert("Cookie Control: please provide an options object with a valid API Key and product name.");
        return -1
    }
    a.product = a.product || "CookieControl Free";
    a.pollPeriod = a.pollPeriod || 25;
    a.pollIncrement = a.pollIncrement || 1.25;
    a.jQueryUrl = a.jQueryUrl || "//ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js";
    if ([CookieControl.PROD_FREE, CookieControl.PROD_PAID, CookieControl.PROD_PAID_MULTISITE, CookieControl.PROD_PAID_CUSTOM].indexOf(a.product.toLowerCase()) < 0) {
        alert("Cookie Control: Sorry, the product name '" + a.product + "' is not recognised.\nPlease ensure you have used one of the CookieControl.PROD_x values.");
        return -1
    }
    ...
    document.write('<script type="text/javascript" src="//apikeys.civiccomputing.com/c/v?d=' + encodeURIComponent(document.location.hostname) + "&p=" + encodeURIComponent(a.product) + "&v=" + CookieControl.VERSION + "&k=" + encodeURIComponent(a.apiKey) + '"><\/script>');
